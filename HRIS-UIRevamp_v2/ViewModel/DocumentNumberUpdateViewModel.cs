...
{
    public class DocumentNumberUpdateViewModel
    {
        [StringLength(20)]
        ...
        [Remote("CheckDivisionIfExist", "Validation", AdditionalFields = "comp_id", ErrorMessage = "* Duplicate Document ID")]
        ...
        public string upModules { get; set; }
